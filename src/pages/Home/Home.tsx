...
export function Home() {
	...
	return (
		<Container maw="100vw" p={0}>
			...
			<ContinueReadingSection title="Continue Reading" mangaList={readingList}/>

			<MangaListSection title="My List" mangaList={favoritesListFormat(data.userFavorites.favourites.manga.edges)} />
